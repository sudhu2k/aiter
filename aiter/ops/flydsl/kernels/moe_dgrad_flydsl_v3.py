...
Backward companion to :mod:`moe_fwd_flydsl_v3`. dgrad contracts the incoming grad against the
...
from .moe_fwd_flydsl_v3 import _bootstrap_primus_turbo
...
def gemm_bf16_nn_gather_tile(
    ...
    *,
    ...
    Mirrors the forward :func:`moe_fwd_flydsl_v3.gemm_bf16_nt_gather_tile` (same two-loader row
